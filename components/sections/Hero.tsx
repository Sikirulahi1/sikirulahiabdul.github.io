        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.div variants={item}>
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-text-primary leading-tight whitespace-nowrap">
                I am{" "}
            ...
            >
              <button
                ...
                className="w-full sm:w-auto px-12 py-4 bg-gradient-to-r from-accent to-accent-light text-background font-semibold text-base rounded-lg hover:shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all hover:-translate-y-1 flex items-center justify-center gap-3"
              >
                Explore Projects
                <svg
                  width="20"
              ...
              <button
                ...
                className="w-full sm:w-auto px-12 py-4 border-2 border-accent text-text-primary font-semibold text-base rounded-lg hover:bg-accent hover:text-background transition-all hover:-translate-y-1"
              >
                View Resume
              </button>
            </motion.div>
