  ...
  return (
    <section id="about" className="section-container">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-5 gap-12 lg:gap-16 mt-12">
          ...
          >
            {statData.map((stat, index) => (
              <motion.div
                ...
                className="bg-card border border-border-subtle rounded-lg p-6 lg:p-8 hover:border-accent transition-colors"
              >
                <div className="text-4xl lg:text-5xl italic text-accent font-bold mb-2">
                ...
                <p className="text-xs lg:text-sm text-text-muted uppercase tracking-wider" style={{ fontFamily: 'var(--font-fira-code), monospace' }}>
                  {stat.label}
                </p>
              </motion.div>
            ))}
